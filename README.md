...
Penultimate Year B.E. Computer Science student at Chitkara University  
- Interested in backend systems, data-driven applications, and analytics  
- Strong foundation in data structures, APIs, and system design fundamentals  
...
- [Financial Portfolio Risk & Analytics Engine](https://financial-risk-analytics-aecwvsaueeyezprswthvjb.streamlit.app/) — A live financial analytics web app that evaluates portfolio risk, volatility, and diversification using real-time market data.
